...
public interface PersonRepository extends JpaRepository<Person, Integer> {
	...
	@Query("select new telran.ashkelon2020.person.dto.CityPopulationDto(p.address.city, count(p)) from ChildOfLove p group by p.address.city order by count(p) desc")
